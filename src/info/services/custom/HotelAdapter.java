...
public class HotelAdapter extends BaseAdapter{
	...
	public HotelAdapter(Context c,ArrayList<String> list,ArrayList<String> list1) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView tv1=(TextView) view.findViewById(R.id.hotel_name);
		TextView tv2=(TextView) view.findViewById(R.id.location);
		ImageView img=(ImageView) view.findViewById(R.id.hotel_img);

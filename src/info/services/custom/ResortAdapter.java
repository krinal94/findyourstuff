...
public class ResortAdapter extends BaseAdapter{
	...
	public ResortAdapter(Context c,ArrayList<String> list,ArrayList<String> list1) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view=inflater.inflate(R.layout.resort_list,null);
		TextView tv1=(TextView) view.findViewById(R.id.resort_name);
		TextView tv2=(TextView) view.findViewById(R.id.location);
		ImageView img=(ImageView) view.findViewById(R.id.resorts_img);

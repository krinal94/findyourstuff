...
public class CabAdapter extends BaseAdapter{
	
	ArrayList<String> H_name;
	ArrayList<String> H_location;
	ArrayList<String> H_image;
	Context context;
	
	public CabAdapter(Context c,ArrayList<String> list,ArrayList<String> list1,ArrayList<String> list2) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view=inflater.inflate(R.layout.cab_list,null);
		TextView tv1=(TextView) view.findViewById(R.id.cab_name);
		TextView tv2=(TextView) view.findViewById(R.id.location);
		ImageView img=(ImageView) view.findViewById(R.id.cab_img);
		Button btn=(Button) view.findViewById(R.id.View_details);
		Log.d("Adapter", "Adapter class");
		String s=H_image.get(position);
		/*try {

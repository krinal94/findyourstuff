...
public class CabSearch extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cab_search);
		
		search=(Button) findViewById(R.id.cabsearch);
        location=(EditText) findViewById(R.id.cablocation);
        ...
        search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO Auto-generated method stub
					...
					Intent intent=new Intent(CabSearch.this,CabActivity.class);

	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				String name=((TextView)view.findViewById(R.id.cab_name)).getText().toString();
				String location =((TextView)view.findViewById(R.id.location)).getText().toString();
				String image =((TextView)view.findViewById(R.id.cab_img)).getText().toString();
				
				Intent i=new Intent(CabActivity.this, HotelDetails.class);
		...
		{
			ProgressDialog dialog=new ProgressDialog(CabActivity.this);
	    	@Override
			...
			protected String doInBackground(String... params) {
				// TODO Auto-generated method stub
				String url1="http://172.16.3.186/cablocation.php?location="+params[0];

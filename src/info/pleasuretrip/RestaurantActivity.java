	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				String name=((TextView)view.findViewById(R.id.restaurant_name)).getText().toString();
				String location =((TextView)view.findViewById(R.id.location)).getText().toString();
				String image =((TextView)view.findViewById(R.id.restaurant_img)).getText().toString();
				
				Intent i=new Intent(RestaurantActivity.this, HotelDetails.class);
		...
		class Data1 extends AsyncTask<String, String, String>
		{
			...
			protected String doInBackground(String... params) {
				// TODO Auto-generated method stub
				String url1="http://172.16.3.186/restlocation.php?location="+params[0];
